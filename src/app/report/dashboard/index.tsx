...
export const DashboardDocument = ({ products, startDate, endDate }: DashboardDocumentProps) => {
  return (
    <Document>
      <Page size="A4" style={styles.page} >
        <View style={styles.header} >
          <Text style={styles.heading}>สรุปผลการขาย</Text>
          <Text style={styles.address}>ระหว่างวันที่ {date2(dayjs(startDate).toDate())} ถึง {date2(dayjs(endDate).toDate())}</Text>
        </View>
        <Divider fixed/>
